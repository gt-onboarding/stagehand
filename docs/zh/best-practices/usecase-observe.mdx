...
## 真实场景用例 {#real-world-use-cases}

### 电商商品探索 {#e-commerce-product-discovery}
...
### 表单处理与验证 {#form-handling-validation}
...
### 动态内容与 SPA 导航 {#dynamic-content-spa-navigation}
...
### 多步工作流规划 {#multi-step-workflow-planning}
