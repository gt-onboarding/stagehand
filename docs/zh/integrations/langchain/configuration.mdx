...
## 步骤 3：创建 Stagehand 实例 {#step-3-create-a-stagehand-instance}
...
## 步骤 4：生成 StagehandToolkit {#step-4-generate-the-stagehandtoolkit}
...
## 步骤 5：使用单个工具 {#step-5-use-individual-tools}
...
## 第 6 步：构建 LangGraph 代理 {#step-6-build-langgraph-agents}
...
### 自定义 Stagehand 配置 {#custom-stagehand-configuration}
