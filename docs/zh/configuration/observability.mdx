...
## Browserbase 会话监控 {#browserbase-session-monitoring}
...
### 实时会话可见性 {#live-session-visibility}
...
### 会话分析与洞察 {#session-analytics-insights}
...
### 会话监控与筛选 {#session-monitoring-filtering}
...
## 本地环境监控 {#local-environment-monitoring}
...
## 实时指标与监控 {#real-time-metrics-monitoring}

### 基本用量跟踪 {#basic-usage-tracking}
...
### 了解指标数据 {#understanding-metrics-data}
...
### 将推理日志写入文件 {#log-inference-to-file}
