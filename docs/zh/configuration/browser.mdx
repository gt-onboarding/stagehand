...
## Browserbase 环境 {#browserbase-environment}
...
### 将 Stagehand 与 Browserbase 配合使用 {#using-stagehand-with-browserbase}
...
### 备选方案：Browserbase SDK {#alternative-browserbase-sdk}
...
#### 连接到已有会话 {#connecting-to-an-existing-session}
...
### 本地高级配置 {#advanced-local-configuration}
...
### 连接到本地浏览器 {#connecting-to-your-local-browser}
